...
public class ChartLine
{
     ...
     */
    private Sprite chartLineDrawable;
     ...
     */
    public ChartLine(int lineNumber, int actualDistance, int expectedDistance, Sprite chartLineDrawable)
    {
     ...
     */
    public Sprite getChartLineDrawable()
    {
